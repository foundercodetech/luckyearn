// ignore_for_file: depend_on_referenced_packages, library_private_types_in_public_api, non_constant_identifier_names, use_build_context_synchronously, camel_case_types, unrelated_type_equality_checks
import 'dart:async';
import 'dart:convert';
...
import 'package:luckyearn/model/TRXBettingModel.dart';
...
import 'package:luckyearn/res/components/clipboard.dart';
...
import 'package:luckyearn/view/home/lottery/trx/commonbottomsheetTRX.dart';
import 'package:luckyearn/view/home/lottery/trx/dummygridTRX.dart';
import 'package:luckyearn/view/home/lottery/trx/imagetoastTRX.dart';
import 'package:luckyearn/view/home/lottery/trx/trxWebBlock.dart';
import 'package:luckyearn/view/home/lottery/trx/trxWebone.dart';
...
class _TrxScreenState extends State<TrxScreen>
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            AppBtn(
                              ...
                              fontSize: 20,
                              border:
                                  Border.all(color: AppColors.browntextprimary),
                            ),
                          ],
                        ),
                        const SizedBox(height: 10),
                        ...
                        return GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Column(
                              children: [
                                selectedCatIndex == index
                                    ? Image.asset(Assets.imagesGoldentime,
                                        height: 70)
  ...
  Partelyrecord(int gameid) async {
    ...
    final response = await http.get(
        Uri.parse("${ApiUrl.colorresultTRX}limit=0&offset=0&gameid=$gameid"));
    if (kDebugMode) {
      print(jsonDecode(response.body));
      print("vygciydt");
      print("${ApiUrl.colorresultTRX}limit=0&offset=1&gameid=$gameid");
    }
  ...
  String hashStar(String input) {
    ...
    // Replace the first two characters with asterisks
    chars[0] = '*';
    chars[1] = '*';
                                  ...
                                  Row(
                                    children: [
                                                  ...
                                                  Navigator.push(
                                                      ...
                                                      MaterialPageRoute(
                                                          builder: (context) =>
                                                              TRXwebBlock(
                                                                url:
                                                                    "https://tronscan.org/#/block/${_listdataResult[index].block.toString()}",
                                                              )));
                                                },
                                                child: Image.asset(
                                      ...
                                      Container(
                                        ...
                                        width: width * 0.13,
                                        child: textWidget(
                                          text: hashStar(_listdataResult[index]
                                              .hash
                                              .toString()),
                                          fontSize: 12,
                                          color: AppColors.primaryTextColor,
                                      ...
                                      SizedBox(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            GradientTextview(
                                              int.parse(_listdataResult[index]
                                                          .number
                                                          .toString()) <
                                                      5
                                                  ? 'S'
  ...
  game_winPopup() async {
    ...
    final response = await http.get(Uri.parse(
        '${ApiUrl.gamewinpopupTRX}userid=$userid&gamesno=$period&gameid=$gameid'));

    var data = jsonDecode(response.body);
    if (kDebugMode) {
      print('${ApiUrl.gamewinpopupTRX}$userid&gamesno=$period&gameid=$gameid');
      print('nbnbnbnbn');
    }
    if (data["status"] == "200") {
          ...
          children: List.generate(
            ...
            (index) {
              return Container(
                ...
                width: width * 0.97,
                decoration:
                    const BoxDecoration(gradient: AppColors.secondaryappbar),
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                  children: [
                    textWidget(
                        text: _listdataResult[index].period.toString(),
                        color: Colors.white),
                    Row(
                        children: generateNumberWidgets(int.parse(
                            _listdataResult[index].number.toString()))),
                    Container(
                      height: 20,
                      width: 20,
  ...
  Future<void> BettingHistoryTRX() async {
    ...
    if (response.statusCode == 200) {
      ...
      setState(() {
        items = responseData
            .map((item) => BettingHistoryModelTRX.fromJson(item))
            .toList();
      });
  ...
  GamehistoryTRX(int gameid) async {
    ...
    final response = await http.get(Uri.parse(
      "${ApiUrl.colorresultTRX}limit=0&gameid=$gameid&offset=$offsetResult",
    ));
    if (kDebugMode) {
      print('pankaj');
      print(
