        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              //   child:  Text(
              //     widget.gameid==1?'K3 Lotre 1 Min':widget.gameid==2?'K3 Lotre 3 Min':widget.gameid==3?'K3 Lotre 5 Min':"K3 Lotre 10 Min",
              //     style: TextStyle(
              //         fontSize: 20,
                      ...
                      Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            // CircleAvatar(
                            //   radius: 18,
                            //   backgroundColor:  widget.colors == null ? Colors.white : widget.colors!.first,
                            //   child:Text(
                            //     "${widget.colorName}",
                      ...
                      child: ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          backgroundColor:  selectedMultiplier == multipliers[index]
                              ? widget.colors!.first:Colors.grey,
