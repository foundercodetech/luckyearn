...
import 'package:luckyearn/model/bettingHistory_Model.dart';
...
import 'package:luckyearn/view/home/lottery/5d/slotmachine.dart';
import 'package:luckyearn/view/home/lottery/K3/commonbottomsheetK3.dart';
import 'package:luckyearn/view/home/lottery/K3/dummygridK3.dart';
import 'package:luckyearn/view/home/lottery/trx/imagetoastTRX.dart';
import 'package:luckyearn/view/test.dart';
                          ...
                          Column(
                            children: [
                              DefaultTabController(
                                length: 4,
                                child: TabBar(
                                  indicator: const BoxDecoration(color: Colors.grey,
                              ...
                              itemCount: 1,
                                ...
                                itemBuilder: (BuildContext, int index){
                                  return Row(
                                    mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                                    children: [
                                      Image.asset(Assets.imagesDiceresult6,height: height*0.07,),
                                      Image.asset(Assets.imagesDiceresult2,height: height*0.07,),
                                      Image.asset(Assets.imagesDiceresult3,height: height*0.07,),
                                    ],
                                  );
                                }),
                          )
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: ListView.builder(
                          ...
                          itemBuilder: (BuildContext, int index){
                            return Center(
                              child: textWidget(text:"2 same number",
                                  color: Colors.white
                              ),
                            );
                          }),
            ...
            return InkWell(
              onTap: (){
                showModalBottomSheet(
                    ...
                    context: (context),
                    builder: (context) {
                      return CommonBottomSheetK3(
                          colors:  [
                            totalitems[index].color, totalitems[index].color
                          ],
                          colorName: totalitems[index].title,
                          predictionType: "10",
                          gameid:gameid);
                    });
                setState(() {
                  selectedItems.add(totalitems[index].title);
                });
              },
              child: Column(
                children: [
                    ...
                    onTap: (){
                      showModalBottomSheet(
                          ...
                          builder: (context) {
                            return CommonBottomSheetK3(
                                colors:  [
                                  SizeTypelist[index].color, SizeTypelist[index].color
                                ],
                                colorName: SizeTypelist[index].type,
                                predictionType: "10",
                                gameid:gameid,
                            );
                          });
