...
import 'package:luckyearn/model/Mlm_Plan_model.dart';
...
import 'package:luckyearn/view/promotion/horizontal_scale.dart';
import 'package:luckyearn/view/promotion/level_plan.dart';
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              children: [
                                Row(
                                  children: [
                                    Image.asset(Assets.iconsInvitionCode,color: AppColors.goldencolortwo,height: height*0.055,),
                                    ...
                                    children: [
                                      ...
                                      InkWell(
                                        ...
                                        child: Container(
                                          height: 55,
                                          width: 120,
                                          decoration:  BoxDecoration(image: DecorationImage(image: AssetImage(Assets.imagesCopyBg), fit: BoxFit.fill)),
                                ...
                                AppBtn(
                                  ...
                                  fontWeight: FontWeight.w900,
                                  onTap: () async {
                                    String referralUrl = 'https://web.luckyearns.in/index.php?id=${userData.referralCode}';
                                    Share.share('Its my referrel Code : *${userData.referralCode}* link to join: $referralUrl  , Downlod Now :https://luckyearns.in/apk/luckyearns.apk', subject: 'Join Now !!');
                                  },
                                ):
                                AppBtn(
                                  ...
                                  onTap: () async {
                                    await FlutterShare.share(
                                        ...
                                        linkUrl: "https://luckyearns.in/apk/luckyearns.apk",
