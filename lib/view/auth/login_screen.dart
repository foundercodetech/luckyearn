...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: GradientAppBar(
          title: Image.asset(Assets.imagesLogoredmeta,height: height*0.12),
                  ...
                  child: Row(
                    children: [
                      Image.asset(selectedButton
                          ? Assets.iconsPhone
                          : Assets.iconsEmailTabColor,color: AppColors.goldencolortwo,height: height*0.05),
  ...
  String email="techluckyearn@gmail.com";
  _launchEmail() async {
